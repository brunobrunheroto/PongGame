...
public class PongClientPlayer2 extends JPanel implements KeyListener {
    ...
    public PongClientPlayer2() {
        JFrame frame = new JFrame("Pong - Player 2");
    ...
    protected void sendInput(int keyCode) throws IOException {
        outputStream.writeInt(2); // Identificador do jogador 2
